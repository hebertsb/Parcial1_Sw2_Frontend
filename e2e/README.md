...
| `dinamica-visible.cjs` | **Voz + UI Dinámica se ve, no se esconde**: nunca aparece la pantalla de Solo Voz; "Mostrame la cartelera" lleva sola a la cartelera; "Quiero entradas para X" **resalta la tarjeta y el horario ANTES de saltar a los asientos** (mide el orden y el tiempo en el navegador); cambiar de función estando en los asientos no te saca de ahí; lo resaltado se apaga solo. |
