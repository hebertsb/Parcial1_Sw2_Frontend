      ...
      <div className="relative z-10 w-full px-space-xl lg:px-space-2xl py-space-xl flex flex-col justify-between max-w-[1720px] mx-auto min-h-[calc(100vh-5rem)]">
        ...
        <div className="flex flex-col items-center text-center space-y-space-sm pt-space-xs">
          <div className="inline-flex items-center gap-space-xs bg-surface-container-low/90 backdrop-blur-md px-space-md py-space-2xs rounded-full shadow-md">
            ...
            <span className="font-label-code text-label-code tracking-widest text-primary uppercase">
              KIOSCO INTELIGENTE #04 • TERMINAL ACTIVA
            </span>
            <span className="text-outline-variant">•</span>
            <span className="font-label-code text-label-code text-on-surface-variant">
              SENSOR DE PROXIMIDAD: PRESENCIAL
            </span>
          </div>
          <div className="space-y-space-2xs max-w-4xl">
            ...
            <p className="font-body-lg text-body-lg text-on-surface-variant font-medium max-w-2xl mx-auto pt-space-2xs">
              Tu experiencia cinematográfica de máxima fidelidad comienza aquí.
              Selecciona tu forma preferida de navegación para continuar:
            </p>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-space-xl lg:gap-space-2xl items-stretch my-space-lg">
          ...
          >
            ...
            <div className="flex items-center justify-between gap-space-md">
              <div className="inline-flex items-center gap-space-xs bg-secondary/10 px-space-sm py-space-xs rounded-full">
                ...
                <span className="font-label-code text-label-code text-secondary uppercase font-bold tracking-wider">
                  Agente Conversacional AI
                </span>
              </div>
            ...
            <div className="flex flex-col items-center justify-center my-space-lg text-center space-y-space-md">
              ...
              <div className="space-y-space-2xs">
                ...
                <p className="font-body-md text-body-md text-on-surface-variant max-w-sm mx-auto">
                  Expresa naturalmente tus gustos, pide horarios específicos o
                  reserva sin navegar por menús.
                </p>
              </div>
            </div>
            ...
            <div className="space-y-space-xs my-space-xs">
              ...
              <div className="grid grid-cols-1 gap-space-xs">
                <div className="bg-surface-container/90 px-space-md py-space-xs rounded-lg flex items-center justify-between transition-colors hover:bg-surface-container-high">
                  ...
                  <span className="font-label-code text-label-code text-outline font-bold">
                    PROBAR
                  </span>
                </div>
                <div className="bg-surface-container/90 px-space-md py-space-xs rounded-lg flex items-center justify-between transition-colors hover:bg-surface-container-high">
            ...
            <button
              className="mt-space-md w-full h-[60px] bg-secondary-container text-on-secondary-container rounded-lg font-headline-sm text-headline-sm flex items-center justify-center gap-space-sm shadow-[0_0_24px_rgba(76,215,246,0.3)] active:scale-95 transition-transform"
              type="button"
            >
          ...
          >
            ...
            <div className="flex items-center justify-between gap-space-md">
              ...
              <span className="font-label-code text-label-code bg-secondary/15 text-secondary border border-secondary/30 px-space-sm py-space-2xs rounded-full uppercase tracking-wider font-bold">
                Nuevo • Carrusel 3D & Trailers
              </span>
            </div>
              ...
              <div className="grid grid-cols-4 gap-space-sm">
                <div className="relative rounded-lg overflow-hidden bg-surface-container-highest shadow-md group/poster">
                  ...
                  <div className="absolute inset-0 bg-gradient-to-t from-surface-container-lowest via-transparent to-transparent flex flex-col justify-end p-space-xs">
                    <span className="font-label-code text-label-code bg-surface-container-lowest/90 text-primary px-space-2xs py-0.5 rounded font-bold self-start mb-0.5">
                      IMAX
                    </span>
                ...
                <div className="relative rounded-lg overflow-hidden bg-surface-container-highest shadow-md group/poster">
                  <div
                    ...
                    style={{
                      backgroundImage:
                        "url('https://lh3.googleusercontent.com/aida-public/AB6AXuDLMu3ASvIClRKbh30yVLdk8HzCRPK6HSeKxDuWw2LU6ft7u-ZNXPo5hjM-QpJbVlVyXkhVpGS8NRrSzdEBC0EVXyugZJiA0QZNHHGvxVig6zA1XG7FioMd1aB2faRk16O2Znn1wP6qhWCHXn82M7M-0JsHK00wzUyTPPMwVVD5iQr_VhcQkgVRanvkkwJerjiRBNY3hOaDf675xlyI0fTPQRPHqxgt6qvgdD4gXcc3j1cs_ec41lxLMg')",
                    }}
                  ></div>
                  <div className="absolute inset-0 bg-gradient-to-t from-surface-container-lowest via-transparent to-transparent flex flex-col justify-end p-space-xs">
                    <span className="font-label-code text-label-code bg-secondary-container text-on-secondary-container px-space-2xs py-0.5 rounded font-bold self-start mb-0.5">
                      4DX
                    </span>
                    <span className="font-body-sm text-body-sm font-bold text-on-surface truncate">
                      Spider-Man
                ...
                <div className="relative rounded-lg overflow-hidden bg-surface-container-highest shadow-md group/poster">
                  <div
                    ...
                    style={{
                      backgroundImage:
                        "url('https://lh3.googleusercontent.com/aida-public/AB6AXuAl39onyeVLK_HAlppWt0muGuFsV3GRtNByq9MsoaU1Wf0ICC5lGKi6x4zmOQZtYn0qayAEsUSJ8hbqnzNBYZBoAcrYhtV4R3N8a0bPO6lMpyKKu7QpkoCxlHfBXC8cCypNs_okWIfNK8m6c9A66k8LP283OA1mKMkuFpG2df1nW6zVwX3a6ciWOCzoRFCsfSXyYCyQPMCLzuTSwmIwnFF7b5jKBYALGlBheWNoZfTMqqOQj88_Xoz2bw')",
                    }}
                  ></div>
                  <div className="absolute inset-0 bg-gradient-to-t from-surface-container-lowest via-transparent to-transparent flex flex-col justify-end p-space-xs">
                    <span className="font-label-code text-label-code bg-surface-container-lowest/90 text-primary px-space-2xs py-0.5 rounded font-bold self-start mb-0.5">
                ...
                <div className="relative rounded-lg overflow-hidden bg-surface-container-highest shadow-md group/poster">
                  <div
                    ...
                    style={{
                      backgroundImage:
                        "url('https://lh3.googleusercontent.com/aida-public/AB6AXuDxrOWNF4E3WJgUq2_BwfUfGwS_mwsP4aDXp_lcOOICn9G59KEqQMnLxYro1hJB8EImmA8hBW2WLDF_u1flAcrq7Yj23WcVecxCKxMBu9-_epcG3Nma5DlwSku8KkylXBu-3f9pUDnq3piV-j6FWPeTxKN7aKR2vtK4VIgbAtcsAvYToToTQqgA800ETG6rOFI1yVZkZ-SksciyovSvyasXC3hPk8Ss5D_BzhzNLtr_yb2fzYFhUAJMpw')",
                    }}
                  ></div>
                  <div className="absolute inset-0 bg-gradient-to-t from-surface-container-lowest via-transparent to-transparent flex flex-col justify-end p-space-xs">
                    <span className="font-label-code text-label-code bg-surface-container-lowest/90 text-tertiary px-space-2xs py-0.5 rounded font-bold self-start mb-0.5">
                      ATMOS
                    </span>
                    <span className="font-body-sm text-body-sm font-bold text-on-surface truncate">
                      El Viaje de Chihiro
            ...
            <div className="space-y-space-2xs text-center lg:text-left">
              <h2 className="font-headline-lg text-headline-lg text-on-surface">
                Explorar Cartelera Táctil
              </h2>
              <p className="font-body-md text-body-md text-on-surface-variant">
                Visualiza salas interactivas, selecciona butacas específicas en
                el mapa curvo y añade palomitas en combo gourmet.
              </p>
            </div>

            <button
              className="mt-space-md w-full h-[60px] bg-primary-container text-on-primary-container rounded-lg font-headline-sm text-headline-sm flex items-center justify-center gap-space-sm shadow-[0_0_24px_rgba(245,158,11,0.35)] active:scale-95 transition-transform"
              type="button"
            >
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-space-md items-center bg-surface-container-lowest/85 backdrop-blur-lg p-space-md rounded-xl shadow-lg mt-auto">
            ...
            <div className="flex flex-col min-w-0">
              <div className="flex items-center gap-space-xs">
                <span className="font-headline-sm text-headline-sm text-on-surface font-semibold truncate">
                  Membresía Cinéfilo Club
                </span>
                <span className="font-label-code text-label-code bg-primary/10 text-primary px-space-xs py-0.5 rounded">
                  OPCIONAL
                </span>
              </div>
              <p className="font-body-sm text-body-sm text-on-surface-variant truncate">
                Acerca tu tarjeta NFC o escanea tu QR para acumular puntos o
                descargar boletos comprados en la app.
              </p>
            </div>
            <button
              className="shrink-0 h-11 px-space-md bg-surface-container-high hover:bg-surface-container-highest text-on-surface rounded-lg font-label-lg text-label-lg flex items-center gap-space-xs transition-colors"
              type="button"
            >
          ...
          <div className="md:col-span-4 flex items-center justify-start md:justify-center gap-space-sm">
            <button
              aria-label="Ajustar Contraste Visual"
              className="h-11 px-space-sm bg-surface-container hover:bg-surface-container-high text-on-surface-variant hover:text-on-surface rounded-lg flex items-center gap-space-xs transition-colors"
              type="button"
            >
              <span className="material-symbols-outlined text-[18px]">
                contrast
            ...
            <button
              aria-label="Asistencia de Audio y Volumen"
              className="h-11 px-space-sm bg-surface-container hover:bg-surface-container-high text-on-surface-variant hover:text-on-surface rounded-lg flex items-center gap-space-xs transition-colors"
              type="button"
            >
              <span className="material-symbols-outlined text-[18px]">
            ...
            <button
              aria-label="Ajuste Altura Silla de Ruedas"
              className="h-11 w-11 bg-surface-container hover:bg-surface-container-high text-on-surface-variant hover:text-on-surface rounded-lg flex items-center justify-center transition-colors"
              type="button"
            >
