...
export const PeliculaCard = ({ pelicula, funciones }: PeliculaCardProps) => {
  ...
  const handleSeleccionar = (funcion: Funcion) => {
    dispatch({
      ...
      payload: { pelicula, horario: funcion.horaInicio },
    });
    ...
    >
      <div className="relative aspect-[2/3] w-full bg-surface-container-low overflow-hidden">
        <div
          ...
          style={{
            backgroundImage: `url('${pelicula.posterUrl ?? posterFor(pelicula.idPelicula)}')`,
          }}
        ></div>
      ...
      <div className="p-space-md flex flex-col flex-1 justify-between gap-space-md">
        ...
        <div className="flex flex-col gap-space-xs bg-surface-container-low p-space-sm rounded-xl">
          <div className="flex items-center justify-between gap-space-xs">
            <span className="text-label-code font-label-code text-on-surface-variant">
              HORARIOS
            </span>
            {señalada && (
          ...
          {funciones.length === 0 ? (
            <span className="py-2 text-center font-body-sm text-body-sm text-on-surface-variant">
            ...
            <div className="grid grid-cols-3 gap-space-2xs">
              {funciones.map((funcion) => (
                <button
                  ...
                  data-funcion-resaltada={
                    resaltado?.idFuncion === funcion.idFuncion
                      ? "true"
                      : undefined
                  }
